...
export function ClarificationCard({ question, options, hasText, onSelect }: Props) {
  return (
    <div
      className={`p-3.5 rounded-[16px] bg-[#F0F2F5]/85 backdrop-blur-md shadow-[6px_6px_16px_#C8D0E0,-6px_-6px_16px_#FFFFFF] border border-white/60 stagger-card max-w-[760px] overflow-hidden flex flex-col ${hasText ? "mt-3" : "mt-0"}`}
