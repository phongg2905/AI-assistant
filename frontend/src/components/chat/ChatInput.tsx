  ...
  return (
    <div className="fixed bottom-0 inset-x-0 bg-transparent border-0 p-3 lg:p-4 z-30 pointer-events-none">
      <div className="max-w-[820px] mx-auto pointer-events-auto relative">
        <div className="relative flex items-center gap-2 p-2 pl-3 rounded-[24px] bg-[#F0F2F5] shadow-[8px_8px_24px_#C8D0E0,-8px_-8px_24px_#FFFFFF] border border-white/60 transition-all overflow-hidden">
