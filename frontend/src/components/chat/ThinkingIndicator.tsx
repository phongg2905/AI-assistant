...
export function ThinkingIndicator() {
  return (
    <div className="flex gap-3 overflow-visible">
      ...
      <div className="pl-2 pr-4 py-2 rounded-2xl bg-[#F0F2F5] shadow-[6px_6px_16px_#C8D0E0,-6px_-6px_16px_#FFFFFF] border border-white/60 flex items-center gap-3 overflow-hidden relative">
