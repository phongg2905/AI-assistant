    ...
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 lg:py-12">
      <div className="w-full max-w-[760px] flex flex-col items-center text-center">
        ...
        <div className="w-full mt-8 relative">
          <LiquidGlass radius={24} frost={0.72} saturation={1.15} bezelWidth={16} thickness={12} refractiveIndex={1.5} surface="convexSquircle" scaleRatio={1} specularOpacity={0.32} blur={0.9} className="w-full">
            <div className="group relative flex items-center gap-2 p-2 pl-3 rounded-[24px] transition-all overflow-hidden">
